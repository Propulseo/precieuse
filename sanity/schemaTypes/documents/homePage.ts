...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Première partie de la phrase d\'accroche, avant le mot mis en valeur.',
      group: 'hero',
    }),
    defineField({
      ...
      type: 'localizedString',
      description: 'Le mot ou groupe de mots affiché en couleur/italique dans la phrase d\'accroche.',
      group: 'hero',
    }),
    defineField({
      name: 'heroSubline',
    ...
    defineField({
      name: 'aproposPlace',
      title: 'Lieu · millésime',
      type: 'string',
      description: 'Ex. « Bordeaux · depuis 2019 ».',
      group: 'avantPropos',
    }),
    defineField({
      ...
      type: 'array',
      description:
        'Phrases en deux temps qui opposent une idée reçue à votre approche, ex. « Pas de production en série » / « Mais des pièces uniques faites à la main ».',
      group: 'avantPropos',
      of: [
        {
          type: 'object',
    ...
    defineField({
      name: 'aproposFounder',
      title: 'Mention fondatrice',
      type: 'localizedString',
      description: 'Ex. « Fondatrice et créatrice de Précieuse ».',
      group: 'avantPropos',
    }),
    ...
    defineField({
      ...
      type: 'array',
      description: 'Courtes promesses affichées en bandeau, ex. « Fabriqué en France », « Or 18 carats ».',
    ...
    defineField({
      name: 'matieresMarginNote',
      title: 'Matières — note de marge',
      type: 'localizedString',
      description: 'Petite annotation affichée à côté du titre, comme une note manuscrite.',
      group: 'sections',
    }),
    ...
    defineField({
      name: 'bespokeMeta',
      title: 'Bloc sur-mesure — mention sous le bouton',
      type: 'localizedString',
    ...
    defineField({
      name: 'leadCaptureConsentPrefix',
      title: 'Formulaire — consentement (avant le lien)',
      type: 'localizedString',
      description: 'Début de la phrase de consentement RGPD, juste avant le lien cliquable vers la confidentialité.',
      group: 'sections',
    }),
    ...
    defineField({
      ...
      type: 'localizedString',
      description: 'Fin de la phrase de consentement, juste après le lien cliquable.',
      group: 'sections',
    }),
