...
async function seedHomePage() {
  ...
  await client.createOrReplace({
    ...
    heroCtaCollection: L('hero_cta_collection'),
    heroCtaBespoke: L('hero_cta_bespoke'),
    ...
    bespokeCta: L('surmesure_cta'),
    bespokeStepLabel: L('sm_step_label'),
    ...
    leadCaptureFieldFirstname: L('leadcapture_field_firstname'),
    leadCaptureFieldLastname: L('leadcapture_field_lastname'),
    leadCaptureFieldEmail: L('leadcapture_field_email'),
    leadCaptureFieldPhone: L('leadcapture_field_phone'),
    leadCaptureSubmit: L('leadcapture_submit'),
    leadCaptureSuccess: L('form_success'),
    leadCaptureError: L('form_error'),
    newsletterEyebrow: L('newsletter_eyebrow'),
    newsletterTitle: L('newsletter_title'),
    newsletterSubtitle: L('newsletter_short_subtitle'),
    newsletterCta: L('newsletter_cta'),
    newsletterPlaceholder: L('newsletter_placeholder'),
