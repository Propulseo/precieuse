    ...
    <HeroBackground>
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 lg:px-12">
        <div className="relative w-full max-w-[1100px] mx-auto motion-safe:animate-[glassRise_1.6s_cubic-bezier(0.2,0.8,0.2,1)_120ms_both]">
          ...
          <div className="relative px-6 py-12 lg:py-20 flex flex-col items-center gap-8">
            <h1
            ...
            <p className="font-display italic text-[20px] lg:text-[28px] text-[#fff7e3] text-center max-w-[40ch] drop-shadow-md motion-safe:animate-[fadeUp_1.4s_ease-out_700ms_both]">
